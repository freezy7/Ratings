//
//  CLChatTableViewController.swift
//  Ratings
//
...
class CLChatTableViewController: UITableViewController {
...
extension CLChatTableViewController: CLHttpTableViewControllerProtocol {
    ...
    func creatDataModel() -> CLDataModel {
        return CLDataModel(delegate: self)
    }
    
}

extension CLChatTableViewController: CLDataModelDelegate {
